...
import { Key, ShieldCheck, Copy, RefreshCw, Plus, Building } from 'lucide-react';
      ...
      <section className="space-y-6">
        ...
        <Card className="card-custom border-none overflow-hidden">
          <CardContent className="p-8 flex items-center justify-between">
            ...
            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex items-center gap-6 group hover:border-brand-primary transition-all text-left">
              <div className="space-y-0.5">
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-wider">Código de Acesso</p>
